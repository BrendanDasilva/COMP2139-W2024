...
namespace Assignment1.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
      ...
      modelBuilder.Entity<Cars>().HasData(
                new Cars { CarId = 1, Brand = "Honda", Model = "Civic Sport", Year = 2019, PricePerDay = 69.99, IsAvailable = true, Location = "Los Angeles" },
                new Cars { CarId = 2, Brand = "Toyota", Model = "Camry SE", Year = 2020, PricePerDay = 79.99, IsAvailable = true, Location = "San Francisco" },
                new Cars { CarId = 3, Brand = "Ford", Model = "Mustang GT", Year = 2018, PricePerDay = 99.99, IsAvailable = true, Location = "New York" },
                new Cars { CarId = 4, Brand = "Chevrolet", Model = "Camaro SS", Year = 2021, PricePerDay = 109.99, IsAvailable = true, Location = "Las Vegas" },
                new Cars { CarId = 5, Brand = "Nissan", Model = "Altima SV", Year = 2020, PricePerDay = 74.99, IsAvailable = true, Location = "Miami" },
                new Cars { CarId = 6, Brand = "Hyundai", Model = "Sonata Limited", Year = 2019, PricePerDay = 69.99, IsAvailable = true, Location = "Seattle" },
                new Cars { CarId = 7, Brand = "Kia", Model = "Optima EX", Year = 2018, PricePerDay = 64.99, IsAvailable = true, Location = "Chicago" },
                new Cars { CarId = 8, Brand = "BMW", Model = "3 Series", Year = 2020, PricePerDay = 129.99, IsAvailable = true, Location = "Boston" },
                new Cars { CarId = 9, Brand = "Mercedes-Benz", Model = "C-Class", Year = 2021, PricePerDay = 139.99, IsAvailable = true, Location = "San Diego" },
                new Cars { CarId = 10, Brand = "Audi", Model = "A4 Premium", Year = 2019, PricePerDay = 119.99, IsAvailable = true, Location = "Houston" }
            );
